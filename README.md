...
[🔗 팀 협업 문서 링크](https://damdada.notion.site/ff97bbb8e51783cdb81d01cf2713f622?v=4fe7bbb8e517839abfa78824b03e9224&source=copy_link)
...
- CSS Module - 컴포넌트 스타일 관리
- Pretendart Font - 한글 웹폰트
...
- **공통**
    ...
    | --- | --- |
    | 공통 컴포넌트  | 버튼 개발  |
    | 레포지토리 초기 구조 설계 | FE 폴더구조 |
    | 배포 작업 | Netlify 를 통한 배포 |
    | 디자인 시스템 개발 | 디자인 시스템 |
...
- **페이지 작업**
    ...
    | 작업 내용 | 참고사항 (설명) |
    | --- | --- |
    | 오늘의 습관 | 체크 토글 인터렉션 기능 구현, 빈 상태 UI 페이지 개발 |
...
- **공통**
    ...
    | --- | --- |
    | 공통  컴포넌트  | Card 개발 |
    | API 연결 분리 초기세팅 | client.js |
    | PasswordGuard | 로직 추가로 비밀 번호 검증 모달을 통해 들어간 페이지에 뒤로 가기 등으로 재 진입 시 스터디 상세 페이지로 보내고  알림 모달 노출 |
- 페이지 작업
...
- **공통**
    ...
    | 작업 내용  | 참고사항 (설명) |
    | --- | --- |
    | 공통 컴포넌트 | 공통 컴포넌트 toast 개발 |
    | 공통 컴포넌트 | 공통 컴포넌트 Container 개발 |
- 페이지 작업
    
    
    | 작업 내용  | 참고사항 (설명) |
    | --- | --- |
    | 오늘의 집중 | 타이머 정지 및 리셋 10초 카운트 다운 구현 |
    | 오늘의 집중 | 타이머 정지시 토스트 이벤트 구현 |
...
- **공통**
    ...
    | 공통 컴포넌트 | Header 개발 |
    | 공통 컴포넌트 | Modal 개발 |
    | 공통 컴포넌트 | 공통 Password Modal 개발 |
    | 공통 클래스 함수 | Clsx 를 통한 공통 컴포넌트 ClassNames 리펙터링 |
- 페이지 작업
    
    
    | 작업 내용  | 참고사항 (설명) |
    | --- | --- |
    | 오늘의 습관 | 목록 수정 모달 기능 개발 |
